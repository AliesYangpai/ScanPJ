...
public class JsonFormatParser implements JsonDeserializer<HttpResult> {
    ...
    @Override
    public HttpResult deserialize(JsonElement json, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        // 根据Json元素获取Json对象。
